...
public interface Device2Repository extends JpaRepository<Device2, Long> {//JpaRepository<Entity클래스, PK타입>
    // 기본적인 CRUD 메소드 자동 생성
    @Query("SELECT p FROM Device2 p ORDER BY p.id ASC")
    List<Device2> findAllDesc();
