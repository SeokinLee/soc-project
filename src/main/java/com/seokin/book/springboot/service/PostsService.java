...
public class PostsService {
    ...
    public Long update(Long id, PostsUpdateRequestDto requestDto) {
        ...
        posts.update(requestDto.getDevice_nm(), requestDto.getSerial_no(), requestDto.getLoadage(), requestDto.getLatitude(), requestDto.getLongitude(), requestDto.getAddress());
